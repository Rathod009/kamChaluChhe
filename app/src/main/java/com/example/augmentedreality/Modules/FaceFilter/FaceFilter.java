...
public class FaceFilter extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        currentview =  inflater.inflate(R.layout.fragment_face_filter, container, false);
        context = getContext();
        ...
        customARFragment = (CustomArFragment)getChildFragmentManager().findFragmentById(R.id.arfragmentfacefilter);
